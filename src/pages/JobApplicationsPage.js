        ...
        <div style={{ paddingTop: 80, minHeight: '100vh', background: 'var(--bg-primary)' }}>
            <div className="container" style={{ padding: '32px 24px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12 }}>
                        <div>
                            ...
                            <p style={{ color: 'var(--text-secondary)', fontSize: 14 }}>
                                {job?.location && <span>{job.location}{job.type ? ' · ' : ''}</span>}
                    ...
                    <div style={{ display: 'flex', gap: 12, marginTop: 20, flexWrap: 'wrap' }}>
                        {[
                            ...
                            <div key={i} style={{
                                ...
                                <span style={{ fontSize: 11, color: 'var(--text-muted)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em', marginTop: 2 }}>{s.label}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                {filtered.length === 0 ? (
                    ...
                    <div style={{
                        display: 'grid',
                        gridTemplateColumns: selectedApp ? 'minmax(280px, 340px) 1fr' : '1fr',
                        gap: 20,
                        alignItems: 'start',
                    }}>
                        {/* ── Candidate List ── */}
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 18 }}>
                                    <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                                        ...
                                        <div>
                                            <h3 style={{ fontSize: 17, fontWeight: 700, marginBottom: 2 }}>{selectedApp.applicant?.name}</h3>
                                            <p style={{ fontSize: 13, color: 'var(--text-secondary)' }}>{selectedApp.applicant?.email}</p>
                                        </div>
                                    </div>
                                    <button
                                ...
                                {showScheduleInterview && (
                                    <div style={{
                                        ...
                                        <h4 style={{ fontSize: 13, fontWeight: 700, marginBottom: 14, color: '#a78bfa', display: 'flex', alignItems: 'center', gap: 7 }}>
                                            <Calendar size={14} />
                                            {selectedApp.status === 'interview' && selectedApp.interviewDate ? 'Reschedule Interview' : 'Schedule Interview'}
                                            {selectedApp.interviewDate && (
                                                <span style={{ marginLeft: 6, fontSize: 11, background: 'rgba(139,92,246,0.2)', color: '#a78bfa', padding: '2px 8px', borderRadius: 20, fontWeight: 500 }}>
                                        ...
                                        <button
                                            ...
                                            style={{ background: 'linear-gradient(135deg,#8b5cf6,#6366f1)', width: '100%', justifyContent: 'center', fontSize: 13 }}
                                        >
                                            {schedulingInterview
                                        ...
                                        {selectedApp.status === 'interview' && selectedApp.interviewDate && (
                                            <button
                                                ...
                                                style={{ width: '100%', justifyContent: 'center', background: 'rgba(239,68,68,0.1)', color: '#f87171', border: '1px solid rgba(239,68,68,0.3)', marginTop: 7, fontSize: 13 }}
                                            >
